...
<Table striped>
	...
	<tbody>
		...
		<tr>
			...
			<td class="redbg" class:fw-bold={match.alliances.red.score > match.alliances.blue.score}>{match.alliances.red.score}</td>
			<td class="redbg" class:fw-bold={match.score_breakdown.red.rp > match.score_breakdown.blue.rp}>{match.score_breakdown.red.rp} RP</td>

			<td class="bluebg" class:fw-bold={match.alliances.blue.score > match.alliances.red.score}>{match.alliances.blue.score}</td>
			<td class="bluebg" class:fw-bold={match.score_breakdown.blue.rp > match.score_breakdown.red.rp}>{match.score_breakdown.blue.rp} RP</td>
		</tr>
