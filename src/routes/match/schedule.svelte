...
<Table striped>
	...
	{#each sortedMatches as m}
		<tr>
			...
			<td class="redbg" class:fw-bold={m.score_breakdown.red.rp > m.score_breakdown.blue.rp}>{m.score_breakdown.red.rp} RP</td>

			<td class="bluebg" class:fw-bold={m.alliances.blue.score > m.alliances.red.score}>{m.alliances.blue.score}</td>
			<td class="bluebg" class:fw-bold={m.score_breakdown.blue.rp > m.score_breakdown.red.rp}>{m.score_breakdown.blue.rp} RP</td>
		</tr>
	{/each}
	</tbody>
</Table>
